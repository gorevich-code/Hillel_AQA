from ApiTestBaseFolder.ApiTestBase import Auth, Users, ApiTestBaseClass, TestDataProcessor
...
class TestSignIn(ApiTestBaseClass):
    ...
    def test_sign_in_valid_data(self):
        ...
        request = Auth.signin(session=self.session, basic_api_url=self.url, data=self.signin_data)
